$(document).ready(function () {
    var do_si = {
        ...
        "울산광역시": ["중구", "동구", "남구", "북구", "울주군"],
        "세종특별자치시": ["세종시"],
        "강원도": ["춘천시", "원주시", "강릉시", "동해시", "태백시", "속초시", "삼척시", "홍천군", "횡성군", "영월군", "평창군", "정선군", "철원군", "화천군", "양구군", "인제군", "고성군", "양양군"],
        "충청북도": ["청주시 상당구", "청주시 서원구", "청주시 흥덕구", "청주시 청원구", "충주시", "제천시", "보은군", "옥천군", "영동군", "진천군", "괴산군", "음성군", "단양군", "증평군"],
    ...
    $("#do-gwang").change(function () {
        var do_gwang = $(this).val();
        console.log(do_gwang);
        var sis = do_si[do_gwang];
        $('#si-gun-gu').empty();
        $.each(sis, function (i, si) {
            $('#si-gun-gu').append(`<option class="si-gun-gu" value="${si}">${si}</option>`);
        });
