...
CREATE TABLE `favorite` (
  ...
  `userid` varchar(16) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL
...
INSERT INTO `favorite` VALUES ('서울특별시 용산구 동자동','ssafy'),('서울특별시 용산구 신계동','ssafy'),('서울특별시 성동구 금호동3가','ssafy');
...
-- Dump completed on 2020-11-26 17:57:13
